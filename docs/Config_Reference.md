...
The ADS131M02 is a 24 bit, 2-channel delta-sigma ADC with simultaneous sampling. It uses SPI communication and provides high precision measurements suitable for load cell probing.
